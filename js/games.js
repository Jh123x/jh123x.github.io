...
var snakesbtn = document.getElementById("snakesbtn");
snakesbtn.addEventListener("click",toggle);
snakesbtn.addEventListener("click",play_game);

function toggle() {
	var toggleid = this.attributes["data-game"].value;
